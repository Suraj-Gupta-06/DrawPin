...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload to update an existing category")
public class UpdateCategoryRequest {
    ...
    @Schema(description = "Detailed description", example = "All forms of digital illustration")
    private String description;

    @Schema(description = "Parent category UUID. Can be null to make it a root category", example = "123e4567-e89b-12d3-a456-426614174000")
